...
if __name__ == '__main__':
    ...
    for room in rooms:
        args.gt_mesh = f'/mnt/user/datasets/replica/culled_mesh/{room}.ply'
        args.rec_mesh = f'/mnt/user/so_nice_slam_1112/checkpoints/replica/{room}/{room}_mesh.ply'

        print(f'Now report reconstruction results of {room}')
