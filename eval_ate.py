...
import yaml
sys.path.append('.')
from utils.common import get_tensor_from_camera
...
if __name__ == '__main__':
    ...
    scale = cfg['scale']
    out_dir = cfg['out_dir'] + '/' + cfg['dataset'] + '/' + cfg['scene'] 
    ckptsdir = f'{out_dir}/model.pt'
    print(out_dir)

    if os.path.exists(ckptsdir):
        
        ckpt = torch.load(ckptsdir, map_location=torch.device('cpu'))
        ...
        evaluate(poses_gt, poses_est,
                 plot=f'{out_dir}/eval_ate_plot.png')
